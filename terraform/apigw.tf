...
resource "aws_api_gateway_integration" "options_save_integration" {
  rest_api_id             = aws_api_gateway_rest_api.xword_saves_api.id
  resource_id             = aws_api_gateway_resource.save.id
...
resource "aws_api_gateway_method_response" "options_save_response_200" {
  rest_api_id = aws_api_gateway_rest_api.xword_saves_api.id
  resource_id = aws_api_gateway_resource.save.id
  http_method = aws_api_gateway_method.options_save.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "options_save_response" {
  depends_on = [aws_api_gateway_integration.options_save_integration]
  rest_api_id = aws_api_gateway_rest_api.xword_saves_api.id
  resource_id = aws_api_gateway_resource.save.id
  http_method = aws_api_gateway_method_response.options_save_response_200.http_method
  status_code = aws_api_gateway_method_response.options_save_response_200.status_code
  response_parameters = {
